 ...
 */
@Data
public class LogMessageQueueEntity implements Serializable {
    ...
    public LogMessageQueueEntity() {
    }

    public LogMessageQueueEntity(String msgId, String msg, Integer status) {
        this.msgId = msgId;
        this.msg = msg;
        this.status = status;
    }
