...
@RestController
@RequestMapping("/customer/deal")
public class TransferCustomerDealController extends AbstractMethodError {
    ...
    @ApiOperation(value = "分页查询-成交客户列表", notes = "请求参数：\n" +
            ...
            "高级查询参数（RequestBody数据格式接收）：[createName:创建人姓名],[姓名:name],[手机:phone],[商机来源：source]\n" +
            "返回参数：【当前页:currPage】，【当前页的数量:size】【总记录数:totalCount】,【总页数:totalPage】,【每页的数量:pageSize】\n" +
            "【姓名:name】,【手机:phone】,【商机来源（0：系统 ,1：官网,2：客服,3：代理网）:source】\n" +
            "【创建人:createName】,【创建时间:createTime】\n" +
            "示例：\n" +
            "{\n" +
            "    \"code\": 0,\n" +
            "    \"msg\": \"成功\",\n" +
