...
public class TransferCustomerPrivateController extends AbstractMethodError {
    ...
    @ApiOperation(value = "分页查询-私海客户列表", notes = "请求参数：\n" +
            ...
            "高级查询参数（RequestBody数据格式接收）：[beginAllotTime:开始创建时间],[endAllotTime:结束创建时间],[beginLastFollowTime:开始创建时间],[endLastFollowTime:结束创建时间]\n" +
            ...
            "【创建人编号:createUserId】,【创建人名称:createUserName】,【分配时间:allotTime】,【跟进时间:lastFollowTime】,【商机状态(0-潜在，1-(失败)有效，2-(失败)无效，3-预约，4-成交)):status】\n" +
            "示例：\n" +
            "{\n" +
            "  \"msg\": \"成功\",\n" +
            "  \"result\": {\n" +
            ...
            "        \"deptName\": \"admin\",\n" +
            "        \"phone\": \"13631153950\",\n" +
            "        \"allotTime\": \"2018-06-11 17:19:24\",\n" +
            "        \"lastFollowTime\": \"2018-06-11 17:19:24\",\n" +
            "        \"status\": 0,\n" +
            "      }\n" +
            "    ],\n" +
            "    \"pageSize\": 10,\n" +
