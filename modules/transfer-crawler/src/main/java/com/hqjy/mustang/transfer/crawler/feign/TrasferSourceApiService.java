...
import com.hqjy.mustang.transfer.crawler.feign.impl.TrasferSourceApiServiceFallbackImpl;
 ...
 */
@FeignClient(name = "transfer-crm", fallback = TrasferSourceApiServiceFallbackImpl.class)
