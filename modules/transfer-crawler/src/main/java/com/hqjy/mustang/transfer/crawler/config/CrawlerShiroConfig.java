...
import com.hqjy.mustang.transfer.crawler.feign.AuthApiService;
...
@Configuration
@Slf4j
public class CrawlerShiroConfig extends AuthShiroConfig {

    private static final String AUTH_NAME = "crawler";
