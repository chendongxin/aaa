package com.hqjy.mustang.school.config;
...
import com.hqjy.mustang.school.fegin.AuthApiService;
...
@Configuration
@Slf4j
public class SchoolShiroConfig extends AuthShiroConfig {
    ...
    protected Map<String, String> getFilterChainDefinitionMap() {
        ...
        filterAnonConfig().getPath().forEach(path -> {
            log.info("mustang-school 不拦截路径 => {}", path);
